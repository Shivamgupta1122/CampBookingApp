...
let CampUpdateComponent = class CampUpdateComponent {
    ...
    ngOnInit() {
        ...
        this.services.getCampById((this.campId)).subscribe((response) => {
            this.Camp = response;
...
CampUpdateComponent = __decorate([
    Component({
...
export { CampUpdateComponent };
//# sourceMappingURL=camp-update.component.js.map